...
```{r}
mf_map(com)
mf_legend(type = "prop", val = c(1000,500,200,10), inches = .5, title = "Population")
```
...
```{r shadow}
mf_shadow(com, col = "grey50")
mf_map(com, col="darkseagreen3", border="darkseagreen4", add=TRUE)
